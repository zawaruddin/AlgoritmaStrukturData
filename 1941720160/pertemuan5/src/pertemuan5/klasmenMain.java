...
public class klasmenMain {
    public static void main(String[] args) {
        ...
        klasmen[] kls = new klasmen[namaTim.length];
        for (int i = 0; i < kls.length; i++) {
            kls[i] = new klasmen(namaTim[i], main[i], selisihGoal[i], poin[i]);
